...
<html lang="en">
    ...
    $sql = "SELECT COUNT('id') as jumlah FROM nikah";
    $raw = mysqli_fetch_array(mysqli_query($mysqli, $sql));
    ?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left shadow h-100 py-2" style="border-color: #ffc0cb; border-left:1px">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-uppercase mb-1" style="color:#27374d">
                                                Wedding Party</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $raw["jumlah"]?></div>
                                        </div>
                                        <div class="col-auto">
