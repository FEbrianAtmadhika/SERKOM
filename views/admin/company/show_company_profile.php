...
<html lang="en">
    ...
    $sql = "SELECT * FROM profile_company";
        ...
        <ul class="navbar-nav  sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #ffc0cb;">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="show_company_profile.php">Show</a>
                    </div>
                </div>
            </li>
            <hr class="sidebar-divider">
        ...
        <div class="col-md-12 col-xl-12">
          <div class="card">
            <div class="card-header p-3 w-100 h-100 justify-content-between align-item-center">
              <h5 class="mb-0"><i class="fas fa-tasks me-2"></i>About Us</h5>
                 ...
                 while($data = mysqli_fetch_array($result)){?>
                    <tr class="fw-normal">
                        <th class="align-middle">
                            <span ><?php echo $data["nama_company"]?></span>
                        </th>
                        <th class="align-middle">
                            <span><?php echo $data["about_us"] ?></span>
                        </th>
                        <th>
                        <img src="../../../asset/profile_company/<?php echo $data['gambar']?>"
                        ...
                        <td class="align-middle">
                          <a href="edit_profile.php?id=<?php echo $data["id"]?>" data-mdb-toggle="tooltip" title="Done"><i
                              class="fas fa-check fa-edit me-3 fa-2x"></i></a>
                              <a href="delete_profile_process.php?id=<?php echo $data['id']?>" data-mdb-toggle="tooltip" title="Remove">
            ...
            <div class="card-footer text-end p-3">
              <button class="btn btn-primary" onclick="window.location.href='add_profile.php'">Add Profile</button>
            </div>
          </div>
