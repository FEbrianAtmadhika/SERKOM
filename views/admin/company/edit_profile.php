...
<html lang="en">
    ...
    $sql = "SELECT * FROM profile_company where id ='$_GET[id]'";
...
<div class="container">
    <div class="d-flex justify-content-between py-3">
        <div class="h4">Add Profile</div>
    </div>
    <div class="card p-sm-5">
        <form class="row g-3">
            <div class="mb-3">
                <input type="hidden" class="form-controll" name="id" value="<?php echo $data['id']?>">
                <label for="Nama" class="form-label">Nama Company</label>
                <input type="text" class="form-control" name="nama" value="<?php echo $data['nama_company']?>">
                
            </div>
            <div class="mb-3">
                <label for="Nama" class="form-label">About Us</label>
                <textarea type="text" class="form-control" name="about"><?php echo $data['about_us']?></textarea>
