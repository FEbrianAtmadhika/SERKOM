        ...
        <div class="col-md-12 col-xl-12">
          <div class="card">
            <div class="card-header p-3 w-100 h-100 justify-content-between align-item-center">
              <h5 class="mb-0"><i class="fas fa-tasks me-2"></i>List Acara Wedding</h5>
                ...
                <?php $i=0;
                 while($data = mysqli_fetch_array($result)){?>
                    <tr class="fw-normal">
                        ...
                        <th>
                          <img src="../../../asset/img/<?php echo $data["Gambar"]?>"
                            class="shadow-1-strong rounded" alt="avatar 1"
                            style="width: 150px; height: auto;">
                        </th>
                        <th class="align-middle">
                            <span ><?php echo $data["mempelai_pria"]?></span>
                        </th>
                        <td class="align-middle" >
                          <span ><?php echo $data["mempelai_wanita"]?></span>
                        </td>
                        <td class="align-middle" >
                          <h6 class="mb-0"><?php echo $data["nama_paket"]?></h6>
                        </td>
                        <td class="align-middle">
