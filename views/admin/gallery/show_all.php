        ...
        <div class="col-md-12 col-xl-12">
          <div class="card">
            <div class="card-header p-3 w-100 h-100 justify-content-between align-item-center">
              <h5 class="mb-0"><i class="fas fa-tasks me-2"></i>Gallery</h5>
                ...
                <?php $i=0;
                 while($data = mysqli_fetch_array($result)){?>
                    <tr class="fw-normal">
                        ...
                        <th>
                          <img src="../../../asset/gallery/<?php echo $data["gambar"]?>"
            ...
            <div class="card-footer text-end p-3">
              <button class="btn btn-primary" onclick="window.location.href='add_new.php'">Add Gallery</button>
            </div>
          </div>
